...
export class NgtwInput {
  protected hostClass = signal(
    'cursor-text rounded-xs border-0 bg-zinc-800 p-2 text-current caret-purple-500 transition-[background-color,_opacity,_box-shadow] outline-none select-all selection:bg-purple-500/25 placeholder:text-zinc-600 focus-visible:ring-2 focus-visible:ring-purple-500 disabled:pointer-events-none disabled:opacity-25',
  );
}
