...
describe('directive:input', () => {
  it('should render an input', async () => {
    ...
    expect(inputElement.classList.contains('px-2')).toBe(true);
    expect(inputElement.classList.contains('py-2')).toBe(true);
    ...
    expect(inputElement.classList.contains('transition-[background-color,_opacity,_box-shadow]')).toBe(true);
    expect(inputElement.classList.contains('outline-none')).toBe(true);
    expect(inputElement.classList.contains('select-all')).toBe(true);
    expect(inputElement.classList.contains('selection:bg-purple-500/25')).toBe(true);
    expect(inputElement.classList.contains('placeholder:text-zinc-600')).toBe(true);
    expect(inputElement.classList.contains('focus-visible:ring-2')).toBe(true);
    expect(inputElement.classList.contains('focus-visible:ring-purple-500')).toBe(true);
    expect(inputElement.classList.contains('disabled:pointer-events-none')).toBe(true);
